...
def test_edit_book(page: Page):
    ...
    page.get_by_role("textbox", name="Type full names, separated by").click()
...
def test_add_book_copy(page: Page):
    ...
    page.get_by_placeholder("Enter number of copies").click()
    page.get_by_placeholder("Enter number of copies").fill("10")
    page.get_by_role("textbox", name="e.g., Shelf A1, Room 201, etc.").click()
...
def test_remove_book_copy(page: Page):
    ...
    page.get_by_placeholder("Number of copies").click()
